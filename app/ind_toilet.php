...
<body style="margin-top: 30px; background-color: #ffffff; ">
    <div class="container" class="container" style="background-color: #ffffff; width: 50%; padding: 30px;  width: 250%; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.3);">
        <br><br>
        <div class="head">
