...
<head>
    <meta charset="UTF-8">
    <title>Project UAS Kelompok 8</title>
    ...
    <div class="container" style="background-color: #ffff; width: 250%; padding: 10px; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.3);">
        ...
        <div class="main">
            ...
            <tr>
                ...
                <th style="color: #000000; width: 5%;">Kode Toilet</th>
                <th style="color: #000000;">Kloset</th>
                <th style="color: #000000;">Wastafel</th>
                <th style="color: #000000;">Lantai</th>
                <th style="color: #000000;">Dinding</th>
                <th style="color: #000000;">Kaca</th>
                <th style="color: #000000;">Bau</th>
                <th style="color: #000000;">Sabun</th>
                <th style="color: #000000;">Petugas</th>
                <th style="color: #000000; width: 5%;">ID Barang</th>
            ...
            <?php endwhile; else: ?>
            <tr>
                <td style="color: #000000;" colspan="7">Belum ada data</td>
            </tr>
            <?php endif; ?>
            </table>
        </div><br><br><br>
